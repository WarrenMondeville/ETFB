...
{
	[ObjectSystem]
	public class MoveComponentV2UpdateSystem : UpdateSystem<MoveComponentV2>
	{
		public override void Update(MoveComponentV2 self)
		{
			self.Update();
		}
	}

	public class MoveComponentV2 : Component
	{
		...
		public void Update()
		{
			...
			unit.Position = Vector2.Lerp(this.StartPos, this.Target, amount);
		}

		public ETTask MoveToAsync(Vector2 target, float speedValue, CancellationToken cancellationToken)
		{
			Unit unit = this.GetParent<Unit>();
