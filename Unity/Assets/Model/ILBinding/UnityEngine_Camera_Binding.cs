...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Camera_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, set_clearFlags_1);
            args = new Type[]{typeof(UnityEngine.Color)};
            method = type.GetMethod("set_backgroundColor", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_backgroundColor_2);
            args = new Type[]{typeof(System.Boolean)};
            method = type.GetMethod("set_orthographic", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_orthographic_3);
            ...
            app.RegisterCLRMethodRedirection(method, get_aspect_6);
            args = new Type[]{typeof(UnityEngine.Vector3)};
            method = type.GetMethod("ScreenToViewportPoint", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ScreenToViewportPoint_7);
            args = new Type[]{typeof(UnityEngine.Vector3)};
            method = type.GetMethod("ScreenPointToRay", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ScreenPointToRay_8);
        ...
        static StackObject* set_clearFlags_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
        ...
        static StackObject* set_backgroundColor_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* set_orthographic_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* get_aspect_6(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* ScreenToViewportPoint_7(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* ScreenPointToRay_8(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
